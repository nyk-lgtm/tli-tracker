...
export function initElements() {
    elements = {
        ...
        statCardBestMap: document.getElementById('stat-card-best-map'),
        statBestMapProfit: document.getElementById('stat-best-map-profit'),
        statBestMapContext: document.getElementById('stat-best-map-context'),
        dropsContainer: document.getElementById('drops-container'),
        dropsList: document.getElementById('drops-list'),
        dropsListMaps: document.getElementById('drops-list-maps'),
        btnInitialize: document.getElementById('btn-initialize'),
        btnPause: document.getElementById('btn-pause'),
        btnReset: document.getElementById('btn-reset'),
        dropsModeToggle: document.getElementById('drops-mode-toggle'),
